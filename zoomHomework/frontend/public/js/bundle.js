...
/* harmony export */   "default": () => (/* binding */ customAjax)
/* harmony export */ });
function customAjax(method, url, obj) {
    ...
    xhr.onreadystatechange = function (event) {
      if (xhr.readyState === XMLHttpRequest.DONE) {
        if (xhr.status === 200) {
          ...
          reject(new Error("Error code: ".concat(statusCode)));
        }
      }
    };
  });
...
/***/ "./frontend/static/js/router/router.js":
/*!*********************************************!*\
  !*** ./frontend/static/js/router/router.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _views_BoardList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../views/BoardList.js */ "./frontend/static/js/views/BoardList.js");
/* harmony import */ var _views_WriteBoard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../views/WriteBoard.js */ "./frontend/static/js/views/WriteBoard.js");
/* harmony import */ var _views_BoardDetail_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../views/BoardDetail.js */ "./frontend/static/js/views/BoardDetail.js");
/* harmony import */ var _views_UpdateBoard_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../views/UpdateBoard.js */ "./frontend/static/js/views/UpdateBoard.js");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            routes = [{
              ...
              path: "/board",
              view: _views_BoardList_js__WEBPACK_IMPORTED_MODULE_1__["default"]
            }, {
              path: "/write",
              view: _views_WriteBoard_js__WEBPACK_IMPORTED_MODULE_2__["default"]
            }, {
              path: "/board/:id",
              view: _views_BoardDetail_js__WEBPACK_IMPORTED_MODULE_3__["default"]
            }, {
              path: "/update/:id",
              view: _views_UpdateBoard_js__WEBPACK_IMPORTED_MODULE_4__["default"]
            }];
            pageMatches = routes.map(function (route) {
              return {
                route: route,
                isMatch: route.path === location.pathname
              };
            });
            match = pageMatches.find(function (pageMatches) {
              return pageMatches.isMatch;
            });
...
var AbstractView = /*#__PURE__*/function () {
  function AbstractView(params) {
    ...
    this.params = params;
    var date = new Date();
    this.convertDate = "".concat(date.getFullYear(), "-").concat(date.getMonth() + 1, "-").concat(date.getDate(), " ").concat(date.getHours() + 1, ":").concat(date.getMinutes());
  }
...
/***/ "./frontend/static/js/views/BoardDetail.js":
/*!*************************************************!*\
  !*** ./frontend/static/js/views/BoardDetail.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./frontend/static/js/views/BoardList.js":
/*!***********************************************!*\
  !*** ./frontend/static/js/views/BoardList.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var BoardList = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(BoardList, [{
    ...
    value: function () {
      ...
      function getBoardList() {
        return _getBoardList.apply(this, arguments);
      }
  ...
  return BoardList;
}(_AbstractView_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
/***/ "./frontend/static/js/views/UpdateBoard.js":
/*!*************************************************!*\
  !*** ./frontend/static/js/views/UpdateBoard.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function createHtml() {
  return "<h1> WelCome to UpdateBoard</h1>";
}
...
/***/ "./frontend/static/js/views/WriteBoard.js":
/*!************************************************!*\
  !*** ./frontend/static/js/views/WriteBoard.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/*!*************************************!*\
  ...
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router_router_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router/router.js */ "./frontend/static/js/router/router.js");
